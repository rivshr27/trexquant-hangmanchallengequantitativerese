...
def collate_fn_wrapper(vocab_size, use_embedding):
    """Wrapper function to create a pickleable collate_fn"""
...
class WordDataLoader(DataLoader):
    def __init__(self, mode, config):
        ...
        # Use a proper function instead of lambda to make it pickleable
        collate_fn = collate_fn_wrapper(config['vocab_size'], config['use_embedding'])
